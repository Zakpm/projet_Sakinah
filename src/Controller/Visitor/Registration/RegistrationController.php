...
class RegistrationController extends AbstractController
{
    ...
    ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $sendEmailService->send([
                "sender_email" => "sakinahsactivities@gmail.com",
                "sender_name" => "Sakinah's activities",
                "recipient_email" => $user->getEmail(),
                "subject" => "Vérification de votre compte sur le site de Sakinah's Activities ",
    ...
    public function emailVerif(User $user, string $token, UserRepository $userRepository): Response
    {
        ...
        if ( $user->isIsVerified()){
            $this->addFlash("success", "Votre compte a bien été vérifié ! Veuillez vous connecter.");
            return $this->redirectToRoute('visitor.welcome.idex');
        }
